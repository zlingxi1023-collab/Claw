...
const LYRICS_DATA = [
  ...
  { startTime: 37.10, endTime: 40.76, text: "But the one little duck with the feather on his back,", singers: ["duck3"], type: "verse", section: "Verse 2",
    action: "☝️ 蓝鸭前移独唱，手摸背部「羽毛」", formation: "verse2Solo" },
  { startTime: 41.52, endTime: 44.30, text: "He led the others with a quack, quack, quack.", singers: ["duck3"], type: "verse", section: "Verse 2",
    action: "🦆 蓝鸭嘎嘎手势领唱", formation: "verse2Solo" },
